...
class TurnEngine:
    ...
    def _run_exam_mini_game(self, exam_type: str) -> float:
        ...
        questions = [
            {
                "q": "在 Python 中，哪一個符號用來代表單行註解？\n  (1) //  (2) #  (3) /*",
                "a": 2,
            },
            {
                "q": "根據遊戲設定，自我滿足感過低時會引發什麼狀態？\n  (1) 興奮異常  (2) 無力狀態  (3) 直接被二一",
                "a": 2,
            },
            {
                "q": "商管程式設計專案協作最常使用哪個版本控制工具？\n  (1) Git & GitHub  (2) Microsoft Word  (3) 小畫家",
                "a": 1,
            },
        ]

        selected_qs = random.sample(questions, 2)
        correct_count = 0
